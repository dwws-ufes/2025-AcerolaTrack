 ...
 * management implementation ({@link br.ufes.progweb.acerolatrack.core.security.AppUserInfo},
 * {@link br.ufes.progweb.acerolatrack.core.security.CurrentUser})</li>
 * <li>A value object for identifying users ({@link com.example.app.security.domain.UserId})</li>
 * <li>Method-level security ({@link br.ufes.progweb.acerolatrack.core.security.CommonSecurityConfig})</li>
